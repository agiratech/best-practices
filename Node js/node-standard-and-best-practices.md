...
The purpose of this document is to present the standards we use in Agira to work with NodeJS.
...
A good solution, and the standard among Agira NodeJs projects is to use a dictionary (object literal) instead. So let’s rewrite the same Mozilla example:
