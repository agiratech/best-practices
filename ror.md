...
# The Rails Best Practices Guide
...
## CSS
* Use SASS/SCSS
* Use "-" in id and classes
* Do not write anything except includes in application.css
* Write basic styles in styles.css. Write controller specific styles in %controller_name%.sass.css
* Try to enclose controller specific styles in .%controller_name% class
* Try to enclose action specific styles in .%controller_name%-%action_name% class

You can assign class to body that way:
```Ruby
def body_class
...
## JavaScript
* Use [gon gem](https://github.com/gazay/gon) to pass vars from ruby to javascript.
* Use [styx gem](https://github.com/inossidabile/styx) for simple CoffeeScript.
* Use [spinejs](http://spinejs.com/) for complex JavaScript.
* Never write inline javascript (exсept google analytics script and other counters)!!! Read more here: http://en.wikipedia.org/wiki/Unobtrusive_JavaScript
